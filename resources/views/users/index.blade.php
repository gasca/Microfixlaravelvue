<x-layouts.app
tittle="Mostrar usuarios"
meta-Descripcion="Usuarios de Microfix"

>

<div class="block space-y-2 p-10 w-1/2 m-auto items-center" >
    <div class="bg-purple-500 h-24  text-center">
        <h1 class="p-1 m-2 text-4xl text-blue-900">{{$title}}</h1>

        <a href="{{route('users.create')}}"
           class="btn-secondary bg-blue-600 rounded p-2 m-1 text-white"
           >Nuevo Usuario</a>
    ...
    @if($users->isNotEmpty())
        ...
        <table class="border-separate border-spacing-2 p-1 border text-center border-slate-500" >
        <thead>
            <tr>
